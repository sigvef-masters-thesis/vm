...
public class emLogServer {
  ...
  public static class getLogServerSettings_args implements org.apache.thrift.TBase<getLogServerSettings_args, getLogServerSettings_args._Fields>, java.io.Serializable, Cloneable, Comparable<getLogServerSettings_args>   {
    ...
    public int hashCode() {
      ...
      boolean present_uniqueExperimentName = true && (isSetUniqueExperimentName());
      list.add(present_uniqueExperimentName);
      if (present_uniqueExperimentName)
        list.add(uniqueExperimentName);
          ...
          switch (schemeField.id) {
            ...
            case 3: // MESSAGE_TYPE
              if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
                struct.messageType = emInterfaces.emLogEventType.findByValue(iprot.readI32());
