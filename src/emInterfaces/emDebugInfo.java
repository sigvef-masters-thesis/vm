...
public class emDebugInfo implements org.apache.thrift.TBase<emDebugInfo, emDebugInfo._Fields>, java.io.Serializable, Cloneable, Comparable<emDebugInfo> {
  ...
  public int hashCode() {
    ...
    boolean present_stateBlobLength = true;
    list.add(present_stateBlobLength);
    if (present_stateBlobLength)
      list.add(stateBlobLength);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.values = new HashMap<String,String>(2*_map16.size);
                String _key17;
                String _val18;
                for (int _i19 = 0; _i19 < _map16.size; ++_i19)
                {
                  ...
                  struct.values.put(_key17, _val18);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, emDebugInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter20 : struct.values.entrySet())
          {
      ...
      if (struct.isSetValues()) {
        {
          ...
          for (Map.Entry<String, String> _iter21 : struct.values.entrySet())
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.values = new HashMap<String,String>(2*_map22.size);
          String _key23;
          String _val24;
          for (int _i25 = 0; _i25 < _map22.size; ++_i25)
          {
            ...
            struct.values.put(_key23, _val24);
          }
        }
        struct.setValuesIsSet(true);
      }
